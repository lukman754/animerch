...
@section('title', 'Perbarui Merchandise - AniMerch System')
@section('page_title', 'Update Informasi Item')
...
<div style="margin-bottom: 2.5rem;">
    <nav style="display: flex; gap: 0.5rem; margin-bottom: 1.5rem; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; color: var(--am-text-muted);">
        ...
        <span>/</span>
        <span style="color: white;">Update Item #{{ $merchandise->id_barang }}</span>
    </nav>
    <h1 style="font-size: 2.5rem; font-weight: 900; color: white; margin-bottom: 0.5rem; letter-spacing: -0.05em;">Edit <span class="text-gradient">Koleksi Item</span></h1>
    <p style="color: var(--am-text-muted); font-size: 1rem;">Perbarui rincian spesifikasi, ketersediaan stok, atau perubahan harga untuk item ini.</p>
</div>
        ...
        <div class="col-lg-8">
            <div class="am-card" style="padding: 2.5rem; background: var(--am-admin-surface);">
                <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid var(--am-border);">
                    <span class="material-symbols-outlined" style="color: var(--am-primary);">edit_document</span>
                    <h3 style="font-weight: 800; font-size: 1.25rem; color: white; margin: 0;">Rincian Informasi</h3>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="am-form-group">
                            ...
                            <input name="id_barang" value="{{ old('id_barang', $merchandise->id_barang) }}" required class="am-input" placeholder="Misal: MERCH-A01">
                    ...
                    <div class="col-md-6">
                        <div class="am-form-group">
                            ...
                            <input name="event_terkait" value="{{ old('event_terkait', $merchandise->event_terkait) }}" required class="am-input" placeholder="Misal: Comifuro 17">
                ...
                <div class="am-form-group">
                    ...
                    <input name="nama_barang" value="{{ old('nama_barang', $merchandise->nama_barang) }}" required class="am-input" placeholder="Misal: Acrylic Standee">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="am-form-group">
                            ...
                            <input name="kategori" value="{{ old('kategori', $merchandise->kategori) }}" class="am-input" placeholder="Misal: Aksesoris">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="am-form-group">
                            ...
                            <div style="position: relative;">
                                ...
                                <input name="harga" value="{{ old('harga', $merchandise->harga) }}" type="number" required class="am-input w-100" style="padding-left: 2.75rem;" placeholder="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="am-form-group">
                            <label class="am-label">Stok Barang <span style="color: var(--am-danger);">*</span></label>
                            <input name="stok" value="{{ old('stok', $merchandise->stok) }}" type="number" required class="am-input" placeholder="0">
                        </div>
                    </div>
                </div>
                ...
                <div class="am-form-group" style="margin-bottom: 0;">
                    ...
                    <textarea name="deskripsi" class="am-input" style="min-height: 120px;" placeholder="Lengkapi dengan detail spesifikasi atau keterangan lainnya...">{{ old('deskripsi', $merchandise->deskripsi) }}</textarea>
                </div>
            </div>
        </div>

        <!-- Right Column: Media Update -->
        <div class="col-lg-4">
            <div class="am-card" style="padding: 2.5rem; background: var(--am-admin-surface); position: sticky; top: 1.5rem;">
                <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid var(--am-border);">
                    ...
                    <h3 style="font-weight: 800; font-size: 1.25rem; color: white; margin: 0;">Update Visual</h3>
                </div>
                ...
                <div style="position: relative; aspect-ratio: 1/1; border: 2px dashed var(--am-border); border-radius: 1.5rem; overflow: hidden; background: var(--am-admin-bg); display: flex; flex-direction: column; align-items: center; justify-content: center; cursor: pointer;"
                    ...
                    @if($merchandise->gambar)
                        <img id="preview_frame" src="{{ asset('storage/merchandise/' . $merchandise->gambar) }}" alt="Preview" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; z-index: 10;">
                    @else
                    ...
                    <div style="text-align: center; color: var(--am-text-muted); padding: 2rem;">
                        <span class="material-symbols-outlined" style="font-size: 3rem; margin-bottom: 1rem;">cloud_sync</span>
                        <p style="font-size: 0.875rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Ganti Foto Produk</p>
                        <p style="font-size: 0.75rem; opacity: 0.6;">Klik untuk unggah baru<br>Biarkan kosong jika tetap</p>
                    </div>
                ...
                <div style="margin-top: 3rem; display: flex; flex-direction: column; gap: 1rem;">
                    <button type="submit" class="am-btn am-btn-primary py-3 w-100" style="background: var(--am-danger); color: white;">
